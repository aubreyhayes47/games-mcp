...
display-only widget UI. Chess, checkers, blackjack, RPG dice, Sea Battle, and the slot machine
are implemented today; planned additions include heads-up NL Hold'em (LLM opponent),
